...
ew_maxTerrainDepth = 20; //Average terrain depth between player and emitting object where signal strength will be 0 (m) -- Default: 20
...
ew_radioPFH = [{
  if (call ew_fnc_playerUsingRadio) then {
    call ew_fnc_clientRadio;
  };
